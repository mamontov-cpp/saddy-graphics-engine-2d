...
struct TestFindContactPointsCtoL : tpunit::TestFixture
{
 public:
   ...
   void test1()
   {
	   ...
	   r1.setRadius(1);
	   r2.setCutter(p2d::cutter(5, 2, 5, -1));
	   ...
	   ASSERT_TRUE(p2d::hasPair(pairs, 2, 1, 5, 1));
   }
   ...
   void test2()
   {
	   ...
	   ASSERT_TRUE( pairs.size() == 1);
	   p2d::PointsPair pair = pairs[0];
	   ASSERT_TRUE(p2d::hasPair(pairs, 5, 1, 5, 1));
   }
   ...
   void test3()
   {
	   ...
	   ASSERT_TRUE( pairs.size() == 1);
	   p2d::PointsPair pair = pairs[0];
	   ASSERT_TRUE(p2d::hasPair(pairs, 6, 1, 5, 1));
   }
   ...
   void test4()
   {
	   ...
	   ASSERT_TRUE( pairs.size() == 1);
	   p2d::PointsPair pair = pairs[0];
	   ASSERT_TRUE(p2d::hasPair(pairs, 9, 1, 5, 1));
   }
   ...
   void test5()
   {
	   ...
	   r1.setRadius(1);
	   r2.setCutter(p2d::cutter(1, 0, 3, 0));
	   p2d::FindContactPoints m;
	   p2d::CollisionShape * s1 = &r1;
	   p2d::CollisionShape * s2 = &r2;
	   p2d::SetOfPointsPair pairs = m.invoke(s1, v1, s2, v2);
	   ASSERT_TRUE( pairs.size() == 1);
	   p2d::PointsPair pair = pairs[0];
	   ASSERT_TRUE(p2d::hasPair(pairs, 1, 1, 1, 0));
   }
   ...
   void test6()
   {
	   ...
	   ASSERT_TRUE( pairs.size() == 1);
	   p2d::PointsPair pair = pairs[0];
	   ASSERT_TRUE(p2d::hasPair(pairs, 1, 0, 1, 0));
   }
   ...
   void test8()
   {
	   ...
	   ASSERT_TRUE( pairs.size() == 1);
	   p2d::PointsPair pair = pairs[0];
	   ASSERT_TRUE(p2d::hasPair(pairs, 1, -3, 1, 0));
   }
   ...
   void test9()
   {
	   ...
	   r2.setCutter(p2d::cutter(0, 3, 0, 5));
	   p2d::FindContactPoints m;
	   p2d::CollisionShape * s1 = &r1;
	   p2d::CollisionShape * s2 = &r2;
	   p2d::SetOfPointsPair pairs = m.invoke(s1, v1, s2, v2);
	   ASSERT_TRUE( pairs.size() == 1);
	   p2d::PointsPair pair = pairs[0];
	   ASSERT_TRUE(p2d::hasPair(pairs, 1, 2, 0, 3));
   }
   ...
   void test10()
   {
	   ...
	   ASSERT_TRUE( pairs.size() == 1);
	   p2d::PointsPair pair = pairs[0];
	   ASSERT_TRUE(p2d::hasPair(pairs, 0, 3, 0, 3));
   }
   ...
   void test11()
   {
	   ...
	   ASSERT_TRUE( pairs.size() == 1);
	   p2d::PointsPair pair = pairs[0];
	   ASSERT_TRUE(p2d::hasPair(pairs, -1, 4, 0, 3));
   }
   ...
   void test12()
   {
	   ...
	   ASSERT_TRUE( pairs.size() == 1);
	   p2d::PointsPair pair = pairs[0];
	   ASSERT_TRUE(p2d::hasPair(pairs, -2, 5, 0, 3));
   }
   ...
   void test13()
   {
	   ...
	   r1.setCenter(p2d::Vector(2, 1));
	   r1.setRadius(M_SQRT2);
	   r2.setCutter(p2d::cutter(-1, 2, 1, 4));
	   p2d::FindContactPoints m;
	   p2d::CollisionShape * s1 = &r1;
	   p2d::CollisionShape * s2 = &r2;
	   p2d::SetOfPointsPair pairs = m.invoke(s1, v1, s2, v2);
