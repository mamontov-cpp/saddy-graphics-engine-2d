...
struct HRectTest : tpunit::TestFixture
{
 public:
   ...
   void test1()
   {
		...
		ASSERT_TRUE(equal(r[0], hPointF(-12, -12)));
		ASSERT_TRUE(equal(r[1], hPointF(12, -12)));
		ASSERT_TRUE(equal(r[2], hPointF(12, 12)));
		ASSERT_TRUE(equal(r[3], hPointF(-12, 12)));
   }

   void test2()
   {
		hRectF r(hPointF(-24,-6), hPointF(25, 7));
		ASSERT_TRUE(equal(r[0], hPointF(-24, -6)));
		ASSERT_TRUE(equal(r[1], hPointF(25, -6)));
		ASSERT_TRUE(equal(r[2], hPointF(25, 7)));
		ASSERT_TRUE(equal(r[3], hPointF(-24, 7)));
   }
