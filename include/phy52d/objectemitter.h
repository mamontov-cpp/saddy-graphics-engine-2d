...
public:
         ...
         */
        inline AbstractObjectEmitter(sad::phy52d::App * app = nullptr) : m_app(app) {}
        ...
        /*! Sets an application
            \param[in] app application
         */
        inline void setApp(sad::phy52d::App * app) { m_app = app; }
        /*! Returns an application
            \return application
         */
        virtual sad::phy52d::App * app() { return m_app; }
        ...
        /*! Produces an object
            \return object
         */
        virtual sad::phy52d::Object * produce() = 0;
        /*! Emits object
         */
...
template<
    typename _Object
>
class RandomDirectionObjectEmitter: public sad::phy52d::AbstractObjectEmitter
{
public:
    RandomDirectionObjectEmitter(sad::phy52d::App * app = nullptr)
    : sad::phy52d::AbstractObjectEmitter(app)
    {
        m_min_angle = 0;
        m_max_angle = 0;
        m_min_angular = 0;
