...
{
    unsigned long ff = basicHash(reinterpret_cast<unsigned char*>(&const_cast<T&>(name)), sizeof(T));  
    return ff % size;
}
...
TDEF unsigned long Hash<Key,T>::count() const 
{ 
    return m_count; 
}

TDEF unsigned long Hash<Key,T>::tableSize() const 
{ 
    return m_table_size; 
}
...
// ====================================== sad::Hash::const_iterator implementation ======================================
...
// ====================================== sad::Hash::iterator implementation ======================================
