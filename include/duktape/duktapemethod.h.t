...
{{/args}}
>
class ConstVoidMethod{{argscount}} : public sad::duktape::DuktapeCallable
{
public:
    /*! A function type, which is being wrapped
     */
    ...
    virtual sad::duktape::DuktapeCallable* clone()
    {
        return new sad::duktape::ConstVoidMethod{{argscount}}<_ClassName{{#has_args}}, {{/has_args}}{{#args}}_Arg{{number}}{{#not_last}}, {{/not_last}}{{/args}}>(m_callee);
    }
    /*! Returns count of required arguments
        \return count of required arguments
     */
...
{{/args}}
>
class ConstRetMethod{{argscount}} : public sad::duktape::DuktapeCallable
{
public:
    /*! A function type, which is being wrapped
     */
    ...
    virtual sad::duktape::DuktapeCallable* clone()  
    {
        return new sad::duktape::ConstRetMethod{{argscount}}<_ClassName, _ReturnType{{#has_args}}, {{/has_args}}{{#args}}_Arg{{number}}{{#not_last}}, {{/not_last}}{{/args}}>(m_callee);
    }
    /*! Returns count of required arguments
        \return count of required arguments
     */
...
{{/args}}
>
inline sad::duktape::DuktapeCallable* make_callable(void (_ClassName::*f)({{#args}}_Arg{{number}}{{#not_last}}, {{/not_last}}{{/args}}) const)
{
    return new ConstVoidMethod{{argscount}}<_ClassName{{#has_args}}, {{/has_args}}{{#args}}{{#not_last}}_Arg{{number}}, {{/not_last}}{{#last}}_Arg{{number}}{{/last}}{{/args}}>(f);
}
...
{{/args}}
>
inline sad::duktape::DuktapeCallable* make_callable(_ReturnType (_ClassName::*f)({{#args}}_Arg{{number}}{{#not_last}}, {{/not_last}}{{/args}}) const)
{
    return new ConstRetMethod{{argscount}}<_ClassName, _ReturnType{{#has_args}}, {{/has_args}}{{#args}}{{#not_last}}_Arg{{number}}, {{/not_last}}{{#last}}_Arg{{number}}{{/last}}{{/args}}>(f);
}
