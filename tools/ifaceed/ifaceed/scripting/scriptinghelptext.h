...
"		<li>property <b>db</b> - contains all operations, related to database properties and object metaprogramming"
"			<ul>"
...
"			</ul>"
"		</li>"
"		<li>property <b>scenes</b> - contains all scene-related operations"
"			<ul>"
"				<li>method <b>list()</b> - lists scenes, returning all of major ids for them</li>"
...
"			</ul>"
"		</li>"
"		<li>property <b>scenenodes</b> - contains all operations related scene nodes"
"			<ul>"
"				<li>method <b>list()</b> - lists all scenenodes from all scenes, returning all of majorids for them</li>"
...
"						<li><b>[Label or Custom Object]</b>property <b>\"hasformatting\"</b>  - a boolean property of whether XML-like formatting should be applied to a label or object.</li>"
...
"			</ul>"
"		</li>"
"		<li>property <b>ways</b> - contains all operations related to ways"
"			<ul>"
"				<li>method <b>list()</b> - lists all ways, returning all of major ids for them</li>"
...
"			</ul>"
"		</li>"
"		<li>property <b>dialogues</b> - contains all operations related to dialogues"
"			<ul>"
"				<li>method <b>list()</b> - lists all dialogues, returning all of major ids for them</li>"
...
"			</ul>"
"		</li>"
"		<li>property <b>animations</b> - contains all operations related to animations"
"			<ul>"
...
"						<li>method <b>_addInstance(name, reference to animation from database or resource as number or string, reference to object, starting time)</b> - adds new instance. id of animation from database take priority if it valid.</li>"
...
"			</ul>"
"		</li>"
"		<li>property <b>layouts</b> - contains all operations, related to layout grids"
"			<ul>"
"				<li>method <b>list()</b> - lists layout grids, returning all of major ids for them</li>"
"				<li>method <b>query(\"name or major id of object\")</b> - returns scriptable grid object (ScriptableGrid) by it's name or major id. Returns null if grid is not found </li>"
"				<li>method <b>add(\"name\" or nothing)</b> - adds new grid with specified name (or empty if not specified). Returns scriptable grid object (ScriptableGrid). </li>"
"				<li>method <b>remove(\"name or major id of object\")</b> - removes a grid by major id or name. Does nothing if grid not found. </li>"
"				<li>method <b>parent(\"name or major id of scene node\")</b> - searches for parent grid cell for object. Returns an array of ScriptableGridCell object for cell if found and a position of object in it, otherwise null. Throws an exception, if object is not found.</li>"
"				<li>method <b>LengthValue(property of E.layouts.Unit, double)</b> - makes a new length value (ScriptableLengthValue), that could be used to set ScriptableGridCell's width or height</li>"
"				<li>method <b>Auto()</b> - returns new length value (ScriptableLengthValue), which describes automatic length of cell</li>"
"				<li>method <b>Pixels(double)</b> - returns new length value (ScriptableLengthValue), which describes length of cell in pixels</li>"
"				<li>method <b>Percents(double)</b> - returns new length value (ScriptableLengthValue), which describes length of cell in percents</li>"
"				<li>property <b>Unit</b> - contains possible units for length value"
"					<ul>"
"						<li>property <b>LU_Auto</b> - length should be computed automatically</li>"
"						<li>property <b>LU_Pixels</b> - length should be computed in pixels</li>"
"						<li>property <b>LU_Percents</b> - length should be computed int percents to width or height of grid</li>"
"					</ul>"
"				</li>"
"				<li>property <b>HorizontalAlignment</b> - contains possible values for horizontal alignment of cell"
"					<ul>"
"						<li>property <b>LHA_Left</b> - objects should be aligned to left of cell</li>"
"						<li>property <b>LHA_Middle</b> - objects should be aligned to middle of cell</li>"
"						<li>property <b>LHA_Right</b> - objects should be aligned to right of cell</li>"
"					</ul>"
"				</li>"
"				<li>property <b>VerticalAlignment</b> - contains possible values for vertical alignment of cell"
"					<ul>"
"						<li>property <b>LVA_Top</b> - objects should be aligned to top of cell</li>"
"						<li>property <b>LVA_Middle</b> - objects should be aligned to middle of cell</li>"
"						<li>property <b>LVA_Bottom</b> - objects should be aligned to bottom of cell</li>"
"					</ul>"
"				</li>"
"				<li>property <b>StackingType</b> - contains possible values for stacking type of cell"
"					<ul>"
"						<li>property <b>LST_Horizontal</b> - objects should be stacked horizontally</li>"
"						<li>property <b>LST_Vertical</b> - objects should be stacked vertically</li>"
"						<li>property <b>LST_NoStacking</b> - objects should be stacked on top of each other</li>"
"					</ul>"
"				</li>"
"			</ul>"
"			"
"			Related non-properties: "
"			"
"			<ul>"
"				<li>Class <b>ScriptableGrid</b> - a reference to real grid. This class provides following operations:"
"					<ul>"
"						<li>method <b>valid()</b> - returns a boolean value, which describes, whether reference is valid</li>"
"						<li>method <b>area()</b> - returns  sad::Rect value, describing area of grid</li>"
"						<li>method <b>setArea(sad::Rect)</b> - tries to set area of grid</li>"
"						<li>method <b>majorId()</b> - returns major id of grid as unsigned long long</li>"
"						<li>method <b>minorId()</b> - returns minor id of grid as unsigned long long</li>"
"						<li>method <b>name()</b> - returns name of grid as string</li>"
"						<li>method <b>setName(string)</b> - set name of grid as string</li>"
"						<li>method <b>fixedWidth()</b> - returns whether grid has fixed width</li>"
"						<li>method <b>setFixedWidth(boolean flag)</b> - toggles flag, whether grid has fixed width</li>"
"						<li>method <b>fixedHeight()</b> - returns whether grid has fixed height</li>"
"						<li>method <b>setFixedHeight(boolean flag)</b> - toggles flag, whether grid has fixed height</li>"
"						<li>method <b>rows()</b> - returns amount of rows in grid</li>"
"						<li>method <b>setRows(int)</b> - sets amount of rows in grid. Throws exception on invalid values</li>"
"						<li>method <b>columns()</b> - returns amount of columns in grid</li>"
"						<li>method <b>setColumns(int)</b> - sets amount of columns in grid. Throws exception on invalid values</li>"
"						<li>method <b>paddingTop()</b> - returns default top padding for grid cells</li>"
"						<li>method <b>paddingBottom()</b> - returns default bottom padding for grid cells</li>"
"						<li>method <b>paddingLeft()</b> - returns default left padding for grid cells</li>"
"						<li>method <b>paddingRight()</b> - returns default right padding for grid cells</li>						"
"						<li>method <b>setPaddingTop(double, [bool])</b> - set top padding for grid. Flag, determines, whether change should be propagated to cells</li>"
"						<li>method <b>setPaddingBottom(double, [bool])</b> - set bottom padding for grid. Flag, determines, whether change should be propagated to cells</li>"
"						<li>method <b>setPaddingLeft(double, [bool])</b> - set left padding for grid. Flag, determines, whether change should be propagated to cells</li>"
"						<li>method <b>setPaddingRight(double, [bool])</b> - set right padding for grid. Flag, determines, whether change should be propagated to cells</li>"
"						<li>method <b>cell(row, col)</b> - returns cell (ScriptableGridCell) by row and column or throws exception if not found</li>"
"						<li>method <b>merge(row, col, rowspan, colspan)</b> - merges cells, specified by region into one if can. Otherwise returns false</li>"
"						<li>method <b>split(row, col, rowspan, colspan)</b> - splits cells, specified by region if can. Otherwise returns false.</li>"
"						<li>method <b>findChild(name of scene node or major id)</b> - returns array of child cell reference (ScriptableGridCell) and position or null if not found.</li>"
"						<li>method <b>children()</b> - returns list of children major ids</li>"
"					</ul>"
"				</li>"
"				<li>Class <b>ScriptableGridCell</b> - a reference to real grid cell. This class provides following operations:"
"					<ul>"
"						<li>method <b>valid()</b> - returns a boolean value, which describes, whether reference is valid</li>"
"						<li>method <b>grid()</b> - returns a major id of grid, which cell belongs to</li>"
"						<li>method <b>area()</b> - returns an area for grid cell as sad::Rect2D</li>"
"						<li>method <b>children()</b> - returns list of children, as list of major ids</li>"
"						<li>method <b>findChild(name or major id of node)</b> - returns null if child is not found, otherwise position of node in cell</li>"
"						<li>method <b>setHeight(ScriptableLengthValue)</b> - sets height settings of cell</li>"
"						<li>method <b>height()</b> - returns height settings of cell as ScriptableLengthValue</li>"
"						<li>method <b>setWidth(ScriptableLengthValue)</b> - sets width settings of cell</li>"
"						<li>method <b>width()</b> - returns width settings of cell as ScriptableLengthValue</li>"
"						<li>method <b>setHorizontalAlignment(member of E.layouts.HorizontalAlignment)</b> - sets horizontal alignment of cell</li>"
"						<li>method <b>horizontalAlignment()</b> - returns horizontal alignment for cell as member of E.layouts.HorizontalAlignment</li>"
"						<li>method <b>setVerticalAlignment(member of E.layouts.VerticalAlignment)</b> - sets vertical alignment of cell</li>"
"						<li>method <b>verticalAlignment()</b> - returns vertical alignment for cell as member of E.layouts.VerticalAlignment</li>"
"						<li>method <b>setStackingType(member of E.layouts.StackingType)</b> - sets stacking type of cell</li>"
"						<li>method <b>stackingType()</b> - returns stacking type of cell  as member of E.layouts.StackingType</li>"
"						<li>method <b>paddingTop()</b> - returns top padding for cell</li>"
"						<li>method <b>paddingBottom()</b> - returns bottom padding for cell</li>"
"						<li>method <b>paddingLeft()</b> - returns left padding for cell</li>"
"						<li>method <b>paddingRight()</b> - returns right padding for cell</li>"
"						<li>method <b>setPaddingTop(double)</b> - set top padding for cell</li>"
"						<li>method <b>setPaddingBottom(double)</b> - set bottom padding for cell</li>"
"						<li>method <b>setPaddingLeft(double)</b> - set left padding for cell</li>"
"						<li>method <b>setPaddingRight(double)</b>- set right padding for cell</li>"
"						<li>method <b>addChild(major id or name of scene node)</b> - adds child node to cell. Returns false if node is already has parent.</li>"
"						<li>method <b>removeChild(int)</b> - removes child of cell. Returns false if position is invalid</li>"
"						<li>method <b>clearChildren()</b> - clears cell, removing all of it's children</li>"
"						<li>method <b>swapChildren(int, int)</b> - swaps two children by positions. Returns false, if positions are invalid</li>"
"						<li>method <b>moveBack(int)</b> - moves child, specified by position in children list, back in children list. Returns false, if position is invalid</li>"
"						<li>method <b>moveFront(int)</b> - moves child, specified by position in children list, front in children list. Returns false, if position is invalid</li>"
"					</ul>"
"				</li>"
"				<li>Class <b>ScriptableLengthValue</b> - a value for width or height of cell"
"					<ul>"
"						<li>method <b>setUnit(property of E.layouts.Unit)</b> - sets current unit for value</li>"
"						<li>method <b>unit()</b> - returns current unit for value as property of E.layouts.Unit</li>"
"						<li>method <b>setValue(double)</b> - sets inner numeric property for value</li>"
"						<li>method <b>value()</b> - returns inner numeric property for value</li>"
"					</ul>"
"				</li>"
"			</ul>"
"		</li>"
