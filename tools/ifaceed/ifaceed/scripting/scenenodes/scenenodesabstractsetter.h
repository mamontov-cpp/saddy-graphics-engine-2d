...
public:
     ...
     */
    virtual void callActions(sad::SceneNode* obj, const sad::String& property_name, _PropertyType old_value,  _PropertyType new_value) override
    {
    ...
    /*! Performs actually setting property
        ...
        \param[in] new_value new value
     */
    virtual void setProperty(sad::SceneNode* obj, const sad::String& property_name, _PropertyType old_value,  _PropertyType new_value)
    {
        core::Editor* editor =  this->m_scripting->editor();

        history::Command* c = this->command(obj, property_name, old_value, new_value);
     ...
     */
    virtual history::Command* command(sad::SceneNode* obj, const sad::String& property_name, _PropertyType old_value,  _PropertyType new_value) = 0;
};
