...
gui::codeedit::Highlighter::Highlighter(QTextDocument *document)
    : QSyntaxHighlighter(document)
{

    m_formats[ScriptNumberFormat].setForeground(QColor(255,128,0));
    m_formats[ScriptStringFormat].setForeground(QColor(128,128,128));
    m_formats[ScriptTypeFormat].setForeground(Qt::darkMagenta);
    m_formats[ScriptKeywordFormat].setForeground(Qt::blue);
    m_formats[ScriptKeywordFormat].setFontWeight(QFont::Bold);
...
gui::codeedit::Highlighter::~Highlighter()
{
}

void gui::codeedit::Highlighter::highlightBlock(const QString &text)
{
...
static QHash<QString, QString> predefinedConstants;
