/*! \file unsignedlonglongdelegate.h
    

    A delegate for property, which contains unsigned long long values
 */
#pragma once
#include "delegate.h"
...
namespace table
{
/*! A delegate for editing values for unsigned long long values
 */
class UnsignedLongLongDelegate: public gui::table::Delegate
{
Q_OBJECT
public:
    /*! Constructs new delegate
     */
    UnsignedLongLongDelegate();
    /*! Destroys delegate
     */
    virtual ~UnsignedLongLongDelegate() override;
