/*!  \file groupschangeproperty.h
 *   
 *
 *   Defines a command type, which describes change of property for animation group
 *   in scene node
 */
#pragma once
...
/*! A command, which describes changing property of animation group
 */
template<
    typename T
>
...
protected:
    /*! A changed animation
     */
    sad::animations::Group* m_animation;
    /*!
    ...
    {
        if (e->shared()->selectedGroup() == m_animation)
        {
