...
void history::scenes::LayerSwap::commit(core::Editor * ob)
{
    ...
    if (ob)
    {
        ob->actions()->sceneActions()->setScenesInList(m_s1, m_s2, m_list_position2, m_list_position1);
    }
}
...
void history::scenes::LayerSwap::rollback(core::Editor * ob)
{
    ...
    if (ob)
    {
        ob->actions()->sceneActions()->setScenesInList(m_s1, m_s2, m_list_position1, m_list_position2);
    }
}
