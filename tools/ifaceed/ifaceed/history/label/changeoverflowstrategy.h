/*! \file changeoverflowstrategy.h
    

    Describe a command, which change how should be exceeding part in line of label handled
 */
#pragma once
 ...
 */
class ChangeOverflowStrategy: public history::scenenodes::ChangeProperty<unsigned int>
{
public:
