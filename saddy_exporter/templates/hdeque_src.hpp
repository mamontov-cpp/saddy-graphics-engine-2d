...
template<class T> inline bool DQ_CIT::hasPrevious() const { return m_parent && (m_prev || m_me); }
template<class T> inline bool DQ_CIT::hasNext() const { return m_parent && (m_next || m_me); }
...
template<class T> inline bool DQ_IT::hasPrevious() const { return m_parent && (m_prev || m_me); }
template<class T> inline bool DQ_IT::hasNext() const { return m_parent && (m_next || m_me); }
