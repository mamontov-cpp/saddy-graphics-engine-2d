@classification = {"excluded"=>
  [["QWidget", "centralWidget"],
   ...
   ["QPushButton", "btnClearCounters"],
   ["QPushButton", "btnFastModeHelp"],
   ["QGroupBox", "grpAnimationsGroupParallelOrSequential"],
   ["QWidget", "widget"],
   ["QVBoxLayout", "grpAnimationsGrouParallelOrSequentialLayout"],
   ["QWidget", "tabAnimationObjectTypesTabBCR"],
   ["QWidget", "tabAnimationObjectTypesTabEasing"],
   ["QGridLayout", "grdAnimationEasing"],
   ["QLabel", "lblAnimationEasingType"],
   ["QLabel", "lblAnimationEasingOvershootAmplitude"],
   ["QLabel", "lblAnimationEasingPeriod"],
   ["QWidget", "layoutWidget1"],
   ["QWidget", "layoutWidgetCustomObjectMethods"],
   ["QWidget", "tabLayouts"],
   ["QWidget", "tabLayoutTabProperties"],
   ["QGridLayout", "grdLayoutRowsCols"],
   ["QLabel", "lblLayoutRows"],
   ["QLabel", "lblLayoutCols"],
   ["QWidget", "widget1"],
   ["QGridLayout", "gridLayoutPaddings"],
   ["QLabel", "lblLayoutPaddingTop"],
   ["QLabel", "lblLayoutPaddingBottom"],
   ["QLabel", "lblLayoutPaddingLeft"],
   ["QLabel", "lblLayoutPaddingRight"],
   ["QWidget", "widget2"],
   ["QHBoxLayout", "grdLayoutFixed"],
   ["QWidget", "tabLayoutTabCells"],
   ["QWidget", "layoutWidgetAnimationEasing"],
   ["QWidget", "layoutWidgetAnimationGroup"],
