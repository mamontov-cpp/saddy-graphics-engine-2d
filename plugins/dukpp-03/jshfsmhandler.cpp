...
sad::dukpp03::JSHFSMHandler::JSHFSMHandler(sad::dukpp03::Context* ctx, sad::dukpp03::CompiledFunction f) : m_ctx(ctx), m_function(f)
{
    m_ctx->addRef();
}

void sad::dukpp03::JSHFSMHandler::invoke()
{
...
sad::dukpp03::JSHFSMHandler::~JSHFSMHandler()
{
