...
sad::os::GLGeometry3D::GLGeometry3D(sad::Renderer* renderer, unsigned int points)
...
sad::os::GLGeometry3D::~GLGeometry3D()
{
...
void sad::os::GLGeometry3D::setVertices(const sad::Rect< sad::Point3D >& vertices) const
{
    if (!m_is_on_gpu)
    {
        return;
...
void sad::os::GLGeometry3D::setVertices(const float* vertexes) const
{
    if (!m_is_on_gpu)
    {
        return;
...
void sad::os::GLGeometry3D::setTextureCoordinates(const float* textureCoordinates) const
{
    if (!m_is_on_gpu)
    {
        return;
...
void sad::os::GLGeometry3D::setTextureCoordinates(const sad::Rect2D& textureCoordinates) const
{
    if (!m_is_on_gpu)
    {
        return;
...
void sad::os::GLGeometry3D::loadToGPU()
{
    if (!m_is_on_gpu)
    {
        sad::os::ExtensionFunctions* f = m_renderer->opengl()->extensionFunctions();
...
void sad::os::GLGeometry3D::unload()
{
    if (m_is_on_gpu)
    {
        sad::os::ExtensionFunctions* f = m_renderer->opengl()->extensionFunctions();
...
void sad::os::GLGeometry3D::drawArrays(GLenum mode, const float* vertexes, const float* tc)
{
    if (!m_is_on_gpu)
    {
        this->loadToGPU();
...
void sad::os::GLGeometry3D::drawArrays(GLenum mode, const sad::Rect<sad::Point3D>& vertexes, const sad::Rect2D& tc)
{
    if (!m_is_on_gpu)
    {
        this->loadToGPU();
...
void sad::os::GLGeometry3D::tryLogGlError(const char* op) const
{
...
void sad::os::GLGeometry3D::drawArrays(GLenum mode) const
{
    sad::os::ExtensionFunctions* f = m_renderer->opengl()->extensionFunctions();
    f->glBindVertexArray(m_vertex_array);
    tryLogGlError("sad::os::GLGeometry::drawArrays: glBindVertexArray(m_vertex_array)");
